...
X10 = data[['PPD - 36 P', 'PPD - 24 P', 'PPD - 16', 'PPD - 11 P', 'PI - 24', 'Interleukina – 44P', 'Interleukina – 24P', 'ubytki klinowe',
            'TWI - 24 suma', 'PPD - 44 P', 'PPD - 36', 'PPD - 31', 'PI - 31', 'Interleukina – 36B', 'Interleukina – 16P', 'Interleukina – 16B',
            'Interleukina – 11P', 'wiek', 'tkliwosc miesni', 'szyna', 'ograniczone otwieranie', 'linea alba', 'impresje jezyka', 'PPD - 11',
            'Interleukina – 31P', 'GI - 31', 'cwiczenia', 'bol miesni', 'TWI - 44 suma', 'TWI - 16 suma', 'TWI - 11 suma', 'PPD - 31 B', 'PPD - 24 B',
            'PPD - 11 B']]

X10 = imputer.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y10,test_size=0.1,random_state=42)
