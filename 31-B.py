...
X10 = data[['PI - 24', 'PI - 16', 'GI - 31', 'PPD - 36 B', 'PPD - 36', 'PPD - 31 B', 'PI - 36', 'GI - 24', 'PPD - 31', 'PPD - 24 P', 'PPD - 16 B',
            'PI - 44', 'PI - 31', 'Interleukina – 24B', 'Interleukina – 16P', 'Interleukina – 11P', 'Interleukina – 11B', 'GI - 44', 'GI - 11',
            'tkliwosc miesni', 'szyna', 'impresje jezyka', 'bol miesni', 'TWI - 11 suma', 'zaciskanie', 'wiek', 'ograniczone otwieranie',
            'TWI - 36 suma', 'TWI - 24 suma', 'TWI - 16 suma', 'PPD - 11 P']]

X10 = imputer2.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y9,test_size=0.1,random_state=42)
