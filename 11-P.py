...
X10 = data[['PI - 36', 'PI - 24', 'PI - 11', 'GI - 31', 'PPD - 44 P', 'PPD - 36 B', 'PPD - 16 P', 'GI - 24', 'PPD - 36', 'PPD - 24 P',
...
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y4,test_size=0.1,random_state=42)
