...
X10 = data[['PI - 16', 'GI - 31', 'PPD - 44', 'PPD - 36 B', 'PPD - 11', 'wiek', 'PPD - 44 P', 'PPD - 36', 'PPD - 31', 'PPD - 16 P', 'PPD - 16',
            'PI - 36', 'PI - 31', 'PI - 24', 'Interleukina – 36P', 'Interleukina – 24B', 'Interleukina – 11P', 'tkliwosc miesni', 'szyna',
            'ograniczone otwieranie', 'TWI - 36 suma', 'TWI - 24 suma', 'PPD - 44 B', 'PPD - 31 B', 'Interleukina – 44B', 'Interleukina – 31P',
            'Interleukina – 24P', 'linea alba', 'TWI - 11 suma', 'PPD - 36 P', 'API', 'PPD - 24 P', 'PPD - 11 B', 'GI - 24']]

X10 = imputer2.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y12,test_size=0.1,random_state=42)
