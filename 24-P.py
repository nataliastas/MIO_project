...
y6 = data[['24-P']]#??
X10 = data[['PI - 36', 'PI - 24', 'PI - 16', 'PPD - 24', 'GI - 31', 'GI - 24', 'TWI - 16 suma', 'PPD - 44', 'PPD - 36 P', 'PPD - 36', 'PPD - 16 P',
            'Interleukina – 44B', 'Interleukina – 36P', 'Interleukina – 36B', 'Interleukina – 11P', 'tkliwosc miesni', 'TWI - 11 suma', 'PPD - 31 B',
            'PI - 11', 'Interleukina – 24B', 'GI - 36', 'zaciskanie', 'szyna', 'impresje jezyka', 'TWI - 36 suma', 'TWI - 31 suma', 'TWI - 24 suma',
            'PPD - 16 B', 'starcie-przednie', 'starcie-boczne', 'plec', 'TWI - 44 suma', 'PPD - 36 B', 'PPD - 11 B']]

X10 = imputer.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y6,test_size=0.1,random_state=42)
