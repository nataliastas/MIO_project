...
X10 = data[['PI - 16','PI - 11','PI - 24','PI - 36','PI - 31','PI - 44','GI - 16','GI - 11','GI - 24','GI - 36','GI - 31','GI - 44',
...
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y3,test_size=0.1,random_state=42)
