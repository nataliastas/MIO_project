...
X10 = data[['PPD - 44 P', 'PPD - 31', 'PI - 11', 'GI - 36', 'PPD - 44', 'PPD - 36', 'PPD - 24 B', 'PPD - 24', 'PPD - 16 P', 'PPD - 11 P', 'PI - 36',
            'PI - 31', 'PI - 16', 'Interleukina – 36P', 'Interleukina – 24B', 'Interleukina – 16P', 'Interleukina – 11P', 'Interleukina – 11B',
            'ograniczone otwieranie', 'cwiczenia', 'TWI - 36 suma', 'TWI - 31 suma', 'TWI - 11 suma', 'PPD - 36 B', 'Interleukina – 24P', 'GI - 24',
            'wiek', 'sztywnosc', 'przygryzanie', 'TWI - 44 suma', 'PPD - 44 B', 'PPD - 24 P', 'PPD - 16 B', 'szyna']]

X10 = imputer.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y8,test_size=0.1,random_state=42)
