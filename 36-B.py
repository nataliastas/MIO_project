...
y7 = data[['36-B']]#??
X10 = data[['wiek', 'PPD - 11', 'Interleukina – 44B', 'Interleukina – 36B', 'Interleukina – 16B', 'GI - 31', 'GI - 11', 'PPD - 44 B', 'PPD - 44',
            'PPD - 24', 'PI - 36', 'PI - 16', 'PI - 11', 'Interleukina – 36P', 'Interleukina – 24B', 'Interleukina – 11P', 'Interleukina – 11B',
            'tkliwosc miesni', 'szyna', 'linea alba', 'impresje jezyka', 'PPD - 36 B', 'PPD - 36', 'PPD - 16 B', 'PPD - 11 P', 'PI - 44',
            'Interleukina – 31B', 'GI - 44', 'TWI - 36 suma', 'TWI - 16 suma', 'PPD - 11 B', 'GI - 36', 'TWI - 44 suma', 'PPD - 16 P']]

X10 = imputer.fit_transform(X10)
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y7,test_size=0.1,random_state=42)
