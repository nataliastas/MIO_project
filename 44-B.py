...
X10 = data[['wiek', 'PPD - 44', 'PPD - 24 P', 'PPD - 24 B', 'PPD - 16', 'PPD - 11', 'TWI - 24 suma', 'PPD - 36 P', 'PPD - 16 B', 'PI - 44',
...
#print(X2)
X_train,X_test,y_train,y_test=train_test_split(X10,y11,test_size=0.1,random_state=42)
